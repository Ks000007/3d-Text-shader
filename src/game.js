class Game {
    constructor() {
        ...
        const game = this;
        this.anims = ['Walking', 'Walking Backwards', 'Turn', 'Running', 'Right Turn'];
    ...
    init() {
        ...
        loader.load(`${this.assetsPath}fbx/people/Guard.fbx`, function(object) {
            ...
            tLoader.load(`${game.assetsPath}images/Guard.png`, function(texture) {
                object.traverse(function(child) {
                    if (child.isMesh) {
    ...
    loadNextAnim(loader) {
        ...
        const game = this;
        loader.load(`${this.assetsPath}fbx/anims/Guard/${anim}.fbx`, function(object) {
